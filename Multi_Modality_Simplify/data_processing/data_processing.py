# Time : 2022/11/28 17:46
# Author : 小霸奔
# FileName: data_processing.p
import collections
...
if __name__ == '__main__':
    ...
    for i in range(len(data_path)):
        ...
        # if "X2" in raw.info["ch_names"]:
        #     if "F3-M2" in raw.info["ch_names"]:
        #         raw = raw.pick_channels(['X2', 'F3-M2', 'C3-M2', 'O1-M2', 'F4-M1', 'C4-M1', 'O2-M1'])
        #     else:
        #         raw = raw.pick_channels(['X2', 'F3-A2', 'C3-A2', 'O1-A2', 'F4-A1', 'C4-A1', 'O2-A1'])
        # else:
        #     if "F3-M2" in raw.info["ch_names"]:
        #         raw = raw.pick_channels(['25', 'F3-M2', 'C3-M2', 'O1-M2', 'F4-M1', 'C4-M1', 'O2-M1'])
        #     else:
        #         raw = raw.pick_channels(['25', 'F3-A2', 'C3-A2', 'O1-A2', 'F4-A1', 'C4-A1', 'O2-A1'])


        folder = f"/data/datasets2/TNSRE-EEGEMG/ISRUC/"
